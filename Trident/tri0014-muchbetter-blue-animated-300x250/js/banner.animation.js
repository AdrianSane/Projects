...
Banner.prototype.start = function () {
  ...
  this.images = ['images/action1.jpg', 'images/action2.jpg', 'images/cta.svg', 'images/packaging.png', 'images/pattern.svg', 'images/txt1.png', 'images/txt2.png', 'images/txtLegal.png', 'images/replay.svg'];
...
Banner.prototype.animate = function () {
  ...
  // end frame
  .to(this.package, .75, { scale: 1, top: 0, left: 0, ease: Back.easeInOut.config(1) }, "-=.5").from(this.txt2, 1, { ease: Elastic.easeOut.config(1, 0.5), scale: .2, opacity: 0 }, "-=.2").to(this.whiteBG, .5, { y: 250, ease: Power4.easeOut }, "-=1.5").to(this.cta, .5, { x: 104, y: 200, ease: Power4.easeOut }, "-=1.2").to(this.txtLegal, .5, { opacity: 1 }, "-=.5").from(this.replay, 0.2, { autoAlpha: 0, ease: Power3.easeOut });
