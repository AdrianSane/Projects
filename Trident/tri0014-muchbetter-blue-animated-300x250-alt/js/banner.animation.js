...
Banner.prototype.start = function () {
  ...
  this.images = ['images/action1.jpg', 'images/action2.jpg',
  //'images/cta.svg',
  'images/packaging.png', 'images/pattern.svg', 'images/txt1.png', 'images/txt2.png', 'images/txtLegal.png'];
...
Banner.prototype.animate = function () {
  ...
  // animate dude
  .to(this.action1, .1, { opacity: 0, ease: SteppedEase.config(1), repeat: 10, repeatDelay: 0.1, yoyo: true }, "-=.25").to(this.action1, .5, { opacity: 0 }).to([this.action1, this.action2], .5, { y: 250, ease: Power4.easeOut }, "-=.1").to(this.whiteBG, .5, { y: 250, ease: Power4.easeOut }, "-=.5")

  // move tiles
  .to(this.container, .5, { y: 0, ease: Power4.easeOut }, "-=.5")

  // end frame
  .to(this.package, .75, { scale: .9, top: 10, left: 0, ease: Back.easeInOut.config(1) }, "-=.75").from(this.txt2, 1, { ease: Elastic.easeOut.config(1, 0.5), scale: .2, opacity: 0 }, "-=.5").from(this.replay, 0.2, { autoAlpha: 0, ease: Power3.easeOut });
