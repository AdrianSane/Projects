...
Banner.prototype.start = function () {
  ...
  // set city name
  this.cityName = 'Rancho Santa Margarita';
  // this.cityName = 'Brooklyn';

  // Image array for preloading
  this.images = ['images/packaging.png', 'images/pattern.svg', 'images/txt2.png', 'images/txtLegal.png', 'images/replay.svg'];
...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineLite().addLabel('start', 0)

  // begin, animate tiles and txt1
  .to(this.cityContainer, 1, { opacity: 1, ease: Elastic.easeOut.config(1, 0.5), scale: 0.95 }, 'start').staggerFrom(_this.tiles, .75, { scale: 0.2, alpha: 0, ease: Back.easeOut, delay: .1 }, 0.04, "-=2.5")
