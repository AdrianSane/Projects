...
Banner.prototype.start = function () {
  ...
  this.images = ['images/action1.jpg', 'images/action2.jpg', 'images/packaging.png', 'images/pattern.svg', 'images/txt1.png', 'images/txtLegal.png', 'images/replay.svg'];
...
Banner.prototype.animate = function () {
  ...
  // shift txt1, whiteBG and packaging
  .to([this.txt1, this.container], .5, { y: -90, ease: Power4.easeOut }, "+=1").to(this.whiteBG, .5, { left: 637, ease: Power4.easeOut }, "-=.5").to(this.package, .75, { left: 555, ease: Back.easeInOut.config(1) }, "-=.75")

  // animate dude up and hide legalText
  .to([this.action1, this.action2], .5, { y: 0, ease: Power4.easeOut }, "-=.35").to(this.txtLegal, .25, { opacity: 0 }, "-=.5")

  // reset txt1 for next transition
  .to(this.txt1, .01, { opacity: 0, left: 0, y: 0, scale: .2 })
  ...
  // end frame
  .to(this.package, .75, { left: 0, ease: Back.easeInOut.config(1) }, "-=.5").to(this.txt1, 1, { ease: Elastic.easeOut.config(1, 0.5), scale: 1, opacity: 1 }, "-=.2").to(this.whiteBG, .5, { x: 728, ease: Power4.easeOut }, "-=1.5").from(this.replay, 0.2, { autoAlpha: 0, ease: Power3.easeOut }).to(this.txtLegal, .25, { opacity: 1 }, "-=.5");
