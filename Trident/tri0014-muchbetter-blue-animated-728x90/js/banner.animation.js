...
Banner.prototype.animate = function () {
  ...
  .to(this.txt1, .01, { opacity: 0, left: 190, y: 0, scale: .2 })
  ...
  // end frame
  .to(this.package, .75, { left: -410, ease: Back.easeInOut.config(1) }, "-=.5").to(this.txt1, 1, { ease: Elastic.easeOut.config(1, 0.5), scale: 1, opacity: 1 }, "-=.2").to(this.whiteBG, .5, { x: 728, ease: Power4.easeOut }, "-=1.5")
