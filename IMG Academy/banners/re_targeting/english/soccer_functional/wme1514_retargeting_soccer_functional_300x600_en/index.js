...
p.nominalBounds = new cjs.Rectangle(0,0,394,648);


(lib.img_athlete2 = function() {
	this.initialize(img.img_athlete2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,433,679);
...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhuHWQgvgSgfgiQgfghgQgsQgPgsAAgzIAAnqQAAg0APgsQAQgsAfghQAfgjAvgRQAwgUA+ABQA/gBAwAUQAvARAfAjQAgAhAPAsQAPAsAAA0IAAHqQAAAzgPAsQgPAsggAhQgfAigvASQgwAUg/gBQg+ABgwgUgAhElAQgSAYAAA3IAAHiQAAA3ASAZQAVAaAvAAQAwAAAVgaQASgZAAg3IAAniQAAg3gSgYQgVgagwAAQgvAAgVAag");
	this.shape.setTransform(513.9,96.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhRHdIAAspIieAAIAAiQIHfAAIAACQIifAAIAAMpg");
	this.shape_1.setTransform(459.2,96.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhRHdIAAspIieAAIAAiQIHfAAIAACQIifAAIAAMpg");
	this.shape_2.setTransform(386.6,96.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhRHdIAAu5ICjAAIAAO5g");
	this.shape_3.setTransform(346.7,96.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AC+HdIAAroIgEAAIiTLoIhOAAIiTroIgEAAIAALoIiOAAIAAu5IDXAAIB0ItIACAAIB0otIDXAAIAAO5g");
	this.shape_4.setTransform(292,96.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AC+HdIAAroIgEAAIiTLoIhOAAIiTroIgDAAIAALoIiOAAIAAu5IDWAAIB1ItIABAAIB0otIDYAAIAAO5g");
	this.shape_5.setTransform(215.3,96.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhvHWQgugSgfgiQggghgPgsQgOgsAAgzIAAnqQAAg0AOgsQAPgsAgghQAfgjAugRQAygUA9ABQA+gBAxAUQAvARAgAjQAeAhAQAsQAPAsAAA0IAAHqQAAAzgPAsQgQAsgeAhQggAigvASQgxAUg+gBQg9ABgygUgAhElAQgSAYAAA3IAAHiQAAA3ASAZQAVAaAvAAQAxAAATgaQATgZAAg3IAAniQAAg3gTgYQgTgagxAAQgvAAgVAag");
	this.shape_6.setTransform(146,96.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(83.6,96.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(520,208.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(466.7,208.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AjcHOIAAubIGoAAIAACLIkKAAIAADtIDMAAIAACKIjMAAIAAEPIEbAAIAACKg");
	this.shape_10.setTransform(415.2,208.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("ABpHOIjJpAIgDAAIAAJAIiPAAIAAubICTAAIDAIQIADAAIAAoQICPAAIAAObg");
	this.shape_11.setTransform(356.9,208.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AhPHOIAAsQIiZAAIAAiLIHRAAIAACLIiaAAIAAMQg");
	this.shape_12.setTransform(303.5,208.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("ABzHOIgcjNIitAAIgcDNIiaAAICqubIDEAAICrObgABAB3Ig/mMIgBAAIg/GMIB/AAg");
	this.shape_13.setTransform(253.7,208.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AjcHOIAAubIGoAAIAACLIkKAAIAADtIDMAAIAACKIjMAAIAAEPIEbAAIAACKg");
	this.shape_14.setTransform(201.8,208.2);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("ABgHOIhwl+IhSAEIAAF6IieAAIAAubIDeAAQBDAAAyAPQAyAQAhAfQAiAiARAzQARA0AABKQAAA1gJArQgKAmgRAdQgOAZgVASQgSAQgWAKICGGigAhiguIA5AAQAhAAAUgHQAXgHAOgQQAOgQAGgcQAGgbAAgpQAAgqgGgbQgGgbgOgQQgOgRgXgHQgUgGghAAIg5AAg");
	this.shape_15.setTransform(144.9,208.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("");
	this.shape_16.setTransform(82.6,208.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline2, new cjs.Rectangle(49,47.1,498.5,245), null);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(513.5,208.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("ACCI7Ij5rJIgDAAIAALJIixAAIAAx0IC1AAIDvKLIACAAIAAqLICxAAIAAR0g");
	this.shape_1.setTransform(440.9,208.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhhI7IAAx0IDDAAIAAR0g");
	this.shape_2.setTransform(385.5,208.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("ACCI7Ij5rJIgEAAIAALJIiwAAIAAx0IC1AAIDvKLIADAAIAAqLICwAAIAAR0g");
	this.shape_3.setTransform(330,208.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhhI7IAAx0IDDAAIAAR0g");
	this.shape_4.setTransform(274.6,208.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("ACOI7Igjj+IjWAAIgjD+Ii9AAIDSx0IDyAAIDTR0gABOCTIhNnpIgCAAIhOHpICdAAg");
	this.shape_5.setTransform(223.6,208.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AB3I7IiLnZIhlAFIAAHUIjEAAIAAx0IETAAQBTAAA9ASQA+ATApAnQAqAqAVA/QAVBAAABbQAABCgMA0QgLAvgVAkQgSAggaAWQgWAUgcALICnIGgAh5g5IBGAAQAogBAagHQAdgJAQgUQASgVAHghQAIgiAAgzQAAgzgIghQgHgigSgUQgQgVgdgIQgagJgoABIhGAAg");
	this.shape_6.setTransform(156.7,208.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhhI7IAAvJIi9AAIAAirII9AAIAACrIi9AAIAAPJg");
	this.shape_7.setTransform(90.7,208.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhuHXQgvgSgggjQgfgggPguQgPgsAAgyIAAnrQAAgzAPgsQAPgsAfghQAggiAvgTQAwgSA+gBQA+ABAxASQAvATAfAiQAfAhAQAsQAPAsAAAzIAAHrQAAAygPAsQgQAugfAgQgfAjgvASQgxASg+ABQg+gBgwgSgAhElAQgSAYAAA4IAAHhQAAA3ASAZQAVAaAvAAQAwAAAVgaQASgZAAg3IAAnhQAAg4gSgYQgVgagwAAQgvAAgVAag");
	this.shape_8.setTransform(514.9,85.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhRHdIAAspIieAAIAAiQIHfAAIAACQIifAAIAAMpg");
	this.shape_9.setTransform(460.2,85.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AhRHdIAAspIieAAIAAiQIHfAAIAACQIifAAIAAMpg");
	this.shape_10.setTransform(387.6,85.6);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhRHdIAAu5ICjAAIAAO5g");
	this.shape_11.setTransform(347.7,85.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AC+HdIAAroIgEAAIiTLoIhOAAIiTroIgEAAIAALoIiNAAIAAu5IDWAAIB0ItIACAAIB0otIDXAAIAAO5g");
	this.shape_12.setTransform(293,85.6);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AC+HdIAAroIgDAAIiULoIhOAAIiTroIgDAAIAALoIiOAAIAAu5IDWAAIB1ItIABAAIB0otIDYAAIAAO5g");
	this.shape_13.setTransform(216.3,85.6);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhvHXQgugSgfgjQgggggPguQgPgsAAgyIAAnrQAAgzAPgsQAPgsAgghQAfgiAugTQAygSA9gBQA/ABAwASQAvATAgAiQAeAhAQAsQAPAsAAAzIAAHrQAAAygPAsQgQAugeAgQggAjgvASQgwASg/ABQg9gBgygSgAhElAQgSAYAAA4IAAHhQAAA3ASAZQAVAaAvAAQAxAAATgaQATgZAAg3IAAnhQAAg4gTgYQgTgagxAAQgvAAgVAag");
	this.shape_14.setTransform(147,85.6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(84.6,85.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline1, new cjs.Rectangle(50,36,499.6,275.1), null);
...
(lib.imgathlete2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(25,297,1.33,1.33);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.imgathlete2, new cjs.Rectangle(25,297,575.9,903.1), null);
...
(lib.imgathlete1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(173,338,1.33,1.33);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.imgathlete1, new cjs.Rectangle(173,338,524,861.8), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(47,45,503,249);
	...
	this.text_1.cache(48,34,504,279);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete1.png?1481825950267", id:"img_athlete1"},
		{src:"images/img_athlete2.png?1481825950267", id:"img_athlete2"},
		{src:"images/img_facilities.png?1481825950267", id:"img_facilities"}
	],
	preloads: []
};
