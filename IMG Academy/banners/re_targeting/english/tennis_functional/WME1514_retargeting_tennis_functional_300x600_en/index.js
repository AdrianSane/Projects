...
p.nominalBounds = new cjs.Rectangle(0,0,450,674);
...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhQHVIAAsdIicAAIAAiMIHYAAIAACMIicAAIAAMdg");
	this.shape.setTransform(513.2,224);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(463.2,224);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AjgHVIAAupIGvAAIAACMIkNAAIAADyIDPAAIAACMIjPAAIAAETIEfAAIAACMg");
	this.shape_2.setTransform(411.8,224);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(354.2,224);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("ABhHVIhxmEIhTAEIAAGAIihAAIAAupIDiAAQBEAAAyAPQA0AQAhAgQAiAiASA0QARA1AABLQAAA2gKArQgJAngRAdQgPAagWASQgRAQgXAKICIGpgAhjgvIA5AAQAiAAAUgHQAYgHAOgRQAOgQAGgcQAHgbAAgqQAAgqgHgbQgGgcgOgRQgOgQgYgIQgUgGgigBIg5AAg");
	this.shape_4.setTransform(270.1,224);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhnHMQgtgQggggQgggggRguQgRgvAAg9IAAq9IChAAIAALEQAAA0AWAZQAUAaArAAQAsAAAUgaQAWgZgBg0IAArEICiAAIAAK9QAAA9gRAvQgQAughAgQggAgguAQQguAQg5AAQg5AAgugQg");
	this.shape_5.setTransform(208.2,224.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhtHQQgtgSgfgiQgfgggPgtQgPgrAAgxIAAnjQAAgzAPgrQAPgsAfghQAfghAtgSQAwgTA9AAQA+AAAwATQAuASAeAhQAfAhAPAsQAPArAAAzIAAHjQAAAxgPArQgPAtgfAgQgeAiguASQgwASg+AAQg9AAgwgSgAhDk6QgRAXgBA2IAAHbQABA2ARAZQAVAZAuAAQAwAAATgZQASgZAAg2IAAnbQAAg2gSgXQgTgagwAAQguAAgVAag");
	this.shape_6.setTransform(147.7,224);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhQHVIAAmFIjDokIClAAIBvFlIADAAIBsllICkAAIjDIkIAAGFg");
	this.shape_7.setTransform(90.9,224);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AktJ4IAAzvIJDAAIAAC+IlqAAIAAFFIEXAAIAAC9IkXAAIAAFyIGDAAIAAC9g");
	this.shape_8.setTransform(506.9,96.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AD8J4IAAvaIgEAAIjEPaIhoAAIjEvaIgDAAIAAPaIi9AAIAAzvIEcAAICcLjIACAAICZrjIEeAAIAATvg");
	this.shape_9.setTransform(419.6,96.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AiTJwQg9gYgqguQgpgrgVg7QgTg6gBhEIAAqKQABhFATg5QAVg8ApgrQAqguA9gXQBBgaBSAAQBTAABBAaQA+AXApAuQApArAVA8QATA5AABFIAAKKQAABEgTA6QgVA7gpArQgpAug+AYQhBAZhTAAQhSAAhBgZgAhamoQgZAfAABKIAAJ/QAABJAZAhQAbAiA/AAQBAAAAagiQAaghAAhJIAAp/QAAhKgagfQgagjhAAAQg/AAgbAjg");
	this.shape_10.setTransform(329.5,96.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(248.4,96.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AkuJ4IAAzvIJFAAIAAC+IlsAAIAAFFIEYAAIAAC9IkYAAIAAFyIGDAAIAAC9g");
	this.shape_12.setTransform(175.3,96.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("");
	this.shape_13.setTransform(98.7,96.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline2, new cjs.Rectangle(52,31,487,278.1), null);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AheIpIAAurIi3AAIAAilIIrAAIAAClIi3AAIAAOrg");
	this.shape.setTransform(512.6,202.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(452.2,202.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AkIIpIAAxQIH8AAIAAClIk+AAIAAEdID0AAIAACkIj0AAIAAFEIFSAAIAACmg");
	this.shape_2.setTransform(390,202.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(320.5,202.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AkHIpIAAxQIH6AAIAAClIk9AAIAAEdID0AAIAACkIj0AAIAAFEIFTAAIAACmg");
	this.shape_4.setTransform(222.5,202.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("ABlIpIAAnqIjJAAIAAHqIi9AAIAAxQIC9AAIAAHCIDJAAIAAnCIC9AAIAARQg");
	this.shape_5.setTransform(152.2,202.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AheIpIAAurIi3AAIAAilIIrAAIAAClIi3AAIAAOrg");
	this.shape_6.setTransform(87.7,202.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("ABTHHIAAmTIilAAIAAGTIidAAIAAuNICdAAIAAFzIClAAIAAlzICcAAIAAONg");
	this.shape_7.setTransform(517.2,85.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhOHHIAAsEIiWAAIAAiJIHJAAIAACJIiXAAIAAMEg");
	this.shape_8.setTransform(464.9,85.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhNHHIAAuNICbAAIAAONg");
	this.shape_9.setTransform(426.8,85.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AB1HHIhxpYIgDAAIhoJYIiDAAIituNICSAAIBgJDIACAAIBmpDICAAAIBqJDIACAAIBXpDICSAAIigONg");
	this.shape_10.setTransform(369.9,85.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("ABnHHIjGo4IgCAAIAAI4IiNAAIAAuNICRAAIC9IHIACAAIAAoHICNAAIAAONg");
	this.shape_11.setTransform(277.2,85.5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AhNHHIAAuNICbAAIAAONg");
	this.shape_12.setTransform(232,85.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("ABxHHIgbjKIirAAIgcDKIiWAAICmuNIDCAAICnONgAA+B1Ig9mFIgBAAIg+GFIB8AAg");
	this.shape_13.setTransform(190.4,85.5);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("ABfHHIhul4IhRADIAAF1IicAAIAAuNIDbAAQBCAAAxAPQAxAPAhAfQAhAhARAyQAQA0AABJQAAA0gJAqQgJAlgRAdQgOAZgVASQgRAPgWAKICEGcgAhggtIA4AAQAggBAUgGQAXgHANgQQAOgQAGgbQAGgbAAgoQAAgpgGgaQgGgcgOgQQgNgQgXgHQgUgGggAAIg4AAg");
	this.shape_14.setTransform(136.1,85.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AhNHHIAAsEIiXAAIAAiJIHJAAIAACJIiXAAIAAMEg");
	this.shape_15.setTransform(82.5,85.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline1, new cjs.Rectangle(56,38,491.1,264), null);
...
(lib.imgathlete1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,301,1.33,1.33);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.imgathlete1, new cjs.Rectangle(0,301,598.5,896.4), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(50,29,491,282);
	...
	this.text_1.cache(54,36,495,268);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete.png?1481826323355", id:"img_athlete"},
		{src:"images/img_facilities.png?1481826323355", id:"img_facilities"}
	],
	preloads: []
};
