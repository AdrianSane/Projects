...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(281.8,209,0.438,0.438);
	...
	this.shape_9.setTransform(68.6,209,0.438,0.438);
...
(lib.ctalabelregistertoday = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#002F53").s().p("");
	this.shape.setTransform(165.3,15.3);
...
p.nominalBounds = new cjs.Rectangle(0,1.5,275.2,29);
...
(lib.ctaregistertodayon = function(mode,startPosition,loop) {
	...
	this.cta_label.setTransform(159.9,45.1,1,1,0,0,0,137.4,26);
	this.cta_label.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 255, 255, 0)];
	this.cta_label.cache(-2,0,279,33);
