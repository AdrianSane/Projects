...
p.nominalBounds = new cjs.Rectangle(0,0,307,339);
...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AiUBkIBujHIC7AAIi2DHg");
	this.shape.setTransform(132.6,56.9,0.569,0.569);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AjwH2IAAvrIHNAAIAACWIkgAAIAAEDIDdAAIAACVIjdAAIAAEnIE0AAIAACWg");
	this.shape_1.setTransform(130.1,97.4,0.569,0.569);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ABoH2Ih5mgQgeAEg7AAIAAGcIitAAIAAvrIDyAAQCUAABGBEQBKBHAACdQAABugnBDQgeAzg0AYICSHHgAhqgzIA9AAQBGAAAcggQAdgiAAhYQAAhYgdgiQgcgghGAAIg9AAg");
	this.shape_2.setTransform(354.6,97.4,0.569,0.569);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AjHG5QhBhFAAhxIAAoFQAAhxBBhFQBGhLCBAAQCCAABGBLQBBBFAABxIAAIFQAABxhBBFQhGBLiCAAQiBAAhGhLgAhHlRQgUAZAAA6IAAH9QAAA6AUAZQAWAcAxAAQAzAAAVgcQAUgZAAg6IAAn9QAAg6gUgZQgVgcgzAAQgxAAgWAcg");
	this.shape_3.setTransform(315.6,97.4,0.569,0.569);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AiVH9IAAiWIAlAAQAxAAAVgVQAUgUAAgrIAAsPICsAAIAAMjQAABogyAzQg6A7iFAAg");
	this.shape_4.setTransform(284.1,97.8,0.569,0.569);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AjwH2IAAvrIHNAAIAACWIkgAAIAAEDIDdAAIAACVIjdAAIAAEnIE0AAIAACWg");
	this.shape_5.setTransform(257.2,97.4,0.569,0.569);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("ADJH2IAAsPIgDAAIicMPIhTAAIibsPIgDAAIAAMPIiWAAIAAvrIDjAAIB5JKIADAAIB6pKIDjAAIAAPrg");
	this.shape_6.setTransform(215.6,97.4,0.569,0.569);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AjdH2IAAvrICtAAIAANVIEOAAIAACWg");
	this.shape_7.setTransform(163.2,97.4,0.569,0.569);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AjwH2IAAvrIHNAAIAACWIkgAAIAAEDIDeAAIAACVIjeAAIAAEnIE0AAIAACWg");
	this.shape_8.setTransform(80.6,97.4,0.569,0.569);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AjBGxQhChNgGh2IClgYQAFBLAcAnQAbAmAqAAQAtAAAbgYQAcgYAAgsQAAhBg3g/QgXgahghSQhUhGglg3Qg3hRAAhhQAAh4BGhBQBGhBB+AAQBnAABABEQA9BBALBuIikASQgFg7gdgcQgXgYgiAAQgpAAgWAaQgXAaAAAvQAAA4A3A8QATAVBlBYQBSBGAmA5QA3BRAABcQAAB6hMBFQhJBCh7AAQhzAAhIhTg");
	this.shape_9.setTransform(44.9,97.4,0.569,0.569);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AjOHIQhDhHAAh1IAAoXQAAh1BDhIQBIhOCGAAQCGAABJBOQBDBIAAB1IAAIXQAAB1hDBHQhJBPiGAAQiFAAhJhPgAhKleQgUAbAAA8IAAIPQAAA8AUAaQAWAdA0AAQA0AAAWgdQAVgaAAg8IAAoPQAAg8gVgbQgWgcg0AAQg0AAgWAcg");
	this.shape_10.setTransform(354.9,166.9,0.569,0.569);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AjKHQQhDhJAAh7IAAoXQAAh0BChJQBGhOB/AAQCAAABIBVQBDBNAAB8IAABCIiqAAQAAhxgZgsQgWgng3AAQhPAAAAByIAAIVQABA1ASAbQAUAeAtAAQA1AAAWghQAWghAAhOIAAhlIhxAAIAAiMIEjAAIAAIOIhWAAIghhOQgrAygkAUQgpAXg7AAQhrAAhChHg");
	this.shape_11.setTransform(315.5,166.9,0.569,0.569);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("Aj4IIIAAwPIHdAAIAACbIkrAAIAAEMIDmAAIAACbIjmAAIAAExIE/AAIAACcg");
	this.shape_12.setTransform(279,166.9,0.569,0.569);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AjIHIQhJhIAAiFIAAsKICzAAIAAMRQAAA5AXAcQAYAcAvAAQBfABAAhyIAAsRICzAAIAAMKQAACEhJBJQhIBHiBABQiAgBhIhHg");
	this.shape_13.setTransform(240.8,167.3,0.569,0.569);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AiaIQIAAidIAmAAQAyABAWgWQAVgVAAgsIAAssICyAAIAANBQAABrgzA1Qg8A+iLAAg");
	this.shape_14.setTransform(208.1,167.3,0.569,0.569);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AjlIIIAAwPICzAAIAANzIEYAAIAACcg");
	this.shape_15.setTransform(169.8,166.9,0.569,0.569);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("Aj4IIIAAwPIHdAAIAACbIkrAAIAAEMIDmAAIAACbIjmAAIAAExIE/AAIAACcg");
	this.shape_16.setTransform(135.5,166.9,0.569,0.569);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AB2IIIjiqJIgDAAIAAKJIiiAAIAAwPICmAAIDZJSIADAAIAApSIChAAIAAQPg");
	this.shape_17.setTransform(81,166.9,0.569,0.569);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("Aj4IIIAAwPIHdAAIAACbIkqAAIAAEMIDlAAIAACbIjlAAIAAExIE+AAIAACcg");
	this.shape_18.setTransform(44,166.9,0.569,0.569);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline2, new cjs.Rectangle(29.8,51.2,340.7,146.1), null);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AkaJwQhchhAAigIAArdQAAigBchhQBkhrC2AAQC4AABjBrQBbBhAACgIAALdQAACghbBhQhjBri4AAQi2AAhkhrgAhlnfQgcAlAABSIAALRQAABSAcAkQAeAnBHAAQBIAAAegnQAcgkAAhSIAArRQAAhSgcglQgegnhIAAQhHAAgeAng");
	this.shape.setTransform(349.6,154.7,0.574,0.574);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AkVJ6QhahjgBioIAArdQABifBYhiQBhhrCtAAQCvAABjBzQBcBqAACpIAABbIjpAAQAAibgig7Qgeg3hLAAQhsAAAACcIAALbQAABIAZAkQAcApA9AAQBJAAAegtQAegtAAhrIAAiKIiaAAIAAjAIGOAAIAALRIh2AAIgthrQg5BFgyAbQg5AehRAAQiTAAhahhg");
	this.shape_1.setTransform(295.2,154.7,0.574,0.574);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AlULIIAA2PIKOAAIAADVImaAAIAAFvIE7AAIAADUIk7AAIAAGiIG1AAIAADVg");
	this.shape_2.setTransform(244.8,154.7,0.574,0.574);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AkRJwQhkhjAAi2IAAwnIDzAAIAAQxQAABPAhAmQAfAnBCAAQBCAAAggnQAggmAAhPIAAwxID0AAIAAQnQAAC2hkBjQhiBhiwAAQiwAAhhhhg");
	this.shape_3.setTransform(192.1,155.2,0.574,0.574);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AjTLRIAAjUIAzAAQBFAAAfgeQAcgcAAg9IAAxWID0AAIAARyQAACUhGBIQhSBUi+gBg");
	this.shape_4.setTransform(147,155.2,0.574,0.574);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ak5LIIAA2PID0AAIAAS6IF/AAIAADVg");
	this.shape_5.setTransform(94,154.7,0.574,0.574);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AlULIIAA2PIKNAAIAADVImYAAIAAFvIE6AAIAADUIk6AAIAAGiIG0AAIAADVg");
	this.shape_6.setTransform(46.7,154.7,0.574,0.574);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("ABvG/IgbjGIinAAIgbDGIiVAAICkt9IC/AAICkN9gAg9BzIB7AAIg9l/IgBAAg");
	this.shape_7.setTransform(356.1,77.8,0.574,0.574);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("ABmG/IjDotIgCAAIAAItIiMAAIAAt9ICPAAIC6H/IACAAIAAn/ICMAAIAAN9g");
	this.shape_8.setTransform(322.3,77.8,0.574,0.574);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("ABmG/IjDotIgCAAIAAItIiMAAIAAt9ICPAAIC6H/IACAAIAAn/ICMAAIAAN9g");
	this.shape_9.setTransform(322.3,77.8,0.574,0.574);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AixGJQg5g+AAhkIAAnMQAAhlA5g9QA/hEByAAQBzAAA/BEQA5A9ABBlIAAHMQgBBkg5A+Qg/BDhzAAQhyAAg/hDgAg/ksQgRAXAAAzIAAHFQAAA0ARAWQATAZAsAAQAtAAAUgZQARgWAAg0IAAnFQAAgzgRgXQgUgZgtAAQgsAAgTAZg");
	this.shape_10.setTransform(288,77.8,0.574,0.574);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhMG/IAAt9ICZAAIAAN9g");
	this.shape_11.setTransform(262.4,77.8,0.574,0.574);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AitGJQg6g+AAhkIAAnMQAAhlA6g9QA+hEBzAAQBuAAA9BJQA5BCAABrIAABBIiaAAIAAhFQAAg1gWgdQgUgaggAAQgsAAgTAZQgSAXAAAzIAAHFQAAA0ASAWQASAZAtAAQAoAAASgYQAQgVAAguIAAhrICaAAIAABnQAABkg5A+Qg9BDhuAAQhzAAg+hDg");
	this.shape_12.setTransform(236.7,77.8,0.574,0.574);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AitGJQg6g+AAhkIAAnMQAAhlA6g9QA+hEBzAAQBuAAA9BJQA5BCAABrIAABBIiaAAIAAhFQAAg1gWgdQgUgaggAAQgsAAgTAZQgSAXAAAzIAAHFQAAA0ASAWQASAZAtAAQAoAAASgYQAQgVAAguIAAhrICaAAIAABnQAABkg5A+Qg9BDhuAAQhzAAg+hDg");
	this.shape_13.setTransform(202.8,77.8,0.574,0.574);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AjVG/IAAt9IGaAAIAACGIkBAAIAADmIDFAAIAACFIjFAAIAAEHIETAAIAACFg");
	this.shape_14.setTransform(171.1,77.8,0.574,0.574);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AjWG/IAAt9IGtAAIAACGIkTAAIAADmIDNAAIAACFIjNAAIAAGMg");
	this.shape_15.setTransform(140.2,77.8,0.574,0.574);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("ABdG/IhslyQggAEgvAAIAAFuIiaAAIAAt9IDYAAQCDAAA+A8QBCBAAACMQAABigiA8QgcAtguAVICCGVgAhegtIA3AAQA+AAAYgdQAageAAhOQAAhPgageQgYgdg+AAIg3AAg");
	this.shape_16.setTransform(107.3,77.8,0.574,0.574);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AjVG/IAAt9IGaAAIAACGIkAAAIAADmIDFAAIAACFIjFAAIAAEHIERAAIAACFg");
	this.shape_17.setTransform(74.4,77.8,0.574,0.574);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("Aj4G/IAAt9IDcAAQCQAABBA8QBEA/AACNQAACNhEA9QhBA9iQAAIhCAAIAAFugAhegtIA7AAQBKAAAdgdQAcgdAAhPQAAhQgcgdQgdgdhKAAIg7AAg");
	this.shape_18.setTransform(41.4,77.8,0.574,0.574);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline1, new cjs.Rectangle(27.2,51.4,343.9,145.2), null);
...
(lib.imgathlete2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(191,50,1.33,1.33);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.imgathlete2, new cjs.Rectangle(191,50,408.3,450.9), null);
...
(lib.imgathlete1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(324,37,1.33,1.33);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.imgathlete1, new cjs.Rectangle(324,37,375,371), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(28,49,345,150);
	...
	this.text_1.cache(25,49,348,149);
	...
	this.athlete_2.setTransform(475.1,269.1,1,1,0,0,0,475.1,269.1);
	...
	this.athlete_1.setTransform(150.4,223.9,1,1,0,0,0,150.4,223.9);
...
p.nominalBounds = new cjs.Rectangle(300,250,699.1,503.5);
// library properties:
lib.properties = {
	width: 600,
	height: 500,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete1.png?1481840221017", id:"img_athlete1"},
		{src:"images/img_athlete2.png?1481840221017", id:"img_athlete2"},
		{src:"images/img_facilities.png?1481840221017", id:"img_facilities"}
	],
	preloads: []
};
