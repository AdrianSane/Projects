...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete.png?1481835344782", id:"img_athlete"},
		{src:"images/img_facilities.png?1481835344782", id:"img_facilities"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,161,136);
...
(lib.textheadline3 = function(mode,startPosition,loop) {
	...
	this.shape_14.setTransform(128.8,117.3,0.735,0.735);
	...
	this.shape_15.setTransform(99.9,117.3,0.735,0.735);
	...
	this.shape_16.setTransform(71.7,117.3,0.735,0.735);
	...
	this.shape_17.setTransform(46.8,117.3,0.735,0.735);
	...
	this.shape_18.setTransform(467.7,64,0.735,0.735);
	...
	this.shape_19.setTransform(443.5,64,0.735,0.735);
	...
	this.shape_20.setTransform(419.1,64,0.735,0.735);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgsEKIAAnDIhZAAIAAhQIELAAIAABQIhZAAIAAHDg");
	this.shape_21.setTransform(395.1,64,0.735,0.735);
	...
	this.shape_22.setTransform(371.9,64,0.735,0.735);
	...
	this.shape_23.setTransform(347.6,64,0.735,0.735);
	...
	this.shape_27.setTransform(236.3,64,0.735,0.735);
	...
	this.shape_30.setTransform(153.6,64,0.735,0.735);
...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(270.1,88,0.59,0.59,0,0,0,-0.2,0.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(93.2,27.7,354,120.5);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(269,90,0.74,0.74);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(47,32.6,444,114.9);
...
p.nominalBounds = new cjs.Rectangle(0,0,484,95.6);
...
(lib.imgathlete1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(660,0,1.33,1.33);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(660,0,214.1,180.9);
...
(lib.footer = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(284,92.2,1.017,1.016,0,0,0,242,50.5);
...
(lib.ctalabelsignup = function(mode,startPosition,loop) {
	...
	// FIND OUT MORE
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#112B53").s().p("AgyAiIAmhDIA/AAIg9BDg");
	this.shape.setTransform(67,0.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#112B53").s().p("AhSCtIAAlZICeAAIAAA0IhiAAIAABZIBLAAIAAAyIhLAAIAABmIBpAAIAAA0g");
	this.shape_1.setTransform(252,24.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#112B53").s().p("AgcCtIAAklIg6AAIAAg0ICtAAIAAA0Ig6AAIAAElg");
	this.shape_2.setTransform(231.4,24.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#112B53").s().p("AhSCtIAAlZICeAAIAAA0IhiAAIAABZIBKAAIAAAyIhKAAIAABmIBpAAIAAA0g");
	this.shape_3.setTransform(212,24.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#112B53").s().p("AhcCtIAAlZIBYAAQBaAAAABcQABAYgKATQgMAVgUAJQAwASAAA+QAAAugVAZQgYAdgwAAgAggB8IAYAAQAWAAAKgOQAJgMAAgbQABgbgLgNQgMgOgYAAIgTAAgAgggeIAVAAQAQAAAKgLQAMgMAAgVQAAgxglAAIgWAAg");
	this.shape_4.setTransform(189.1,24.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#112B53").s().p("AgcCtIAAlZIA5AAIAAFZg");
	this.shape_5.setTransform(170.1,24.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#112B53").s().p("AAkCtIgpiQQgLACgTAAIAACOIg8AAIAAlZIBTAAQAxAAAZAYQAZAYAAA3QAABEgpARIAyCdgAgjgQIAVAAQAXAAAJgLQAKgMAAgeQAAgfgKgMQgJgLgXAAIgVAAg");
	this.shape_6.setTransform(152,24.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#112B53").s().p("AhCCYQgWgYAAgnIAAixQAAgnAWgYQAYgaArAAQAqAAAYAcQAWAbAAApIAAAZIg7AAIAAgbQAAgVgJgLQgIgKgMAAQgQAAgHAKQgHAJAAATIAACuQAAAUAHAJQAHAKAQAAQAQAAAHgJQAGgJAAgSIAAgpIA7AAIAAAoQAAAngWAYQgXAagrAAQgrAAgYgag");
	this.shape_7.setTransform(127.3,24.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#112B53").s().p("AhBCVQgXgbgCgoIA4gJQACAaAKANQAJANANABQAQAAAJgJQAJgIAAgPQAAgWgTgWQgIgJgfgdQg9gxAAg1QAAgpAZgXQAYgXAqAAQAjAAAWAYQAVAXAEAlIg4AGQgCgTgKgLQgIgIgMAAQgcAAAAAiQAAAUATAUQAHAIAhAeQA8AyAAA0QAAAqgaAXQgZAYgpAAQgoAAgYgdg");
	this.shape_8.setTransform(104.7,24.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#112B53").s().p("AAnCtIhKjXIgBAAIAADXIg2AAIAAlZIA4AAIBGDFIABAAIAAjFIA2AAIAAFZg");
	this.shape_9.setTransform(82.2,24.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#112B53").s().p("AgcCtIAAlZIA5AAIAAFZg");
	this.shape_10.setTransform(63.5,24.7);
	...
	this.arrow.setTransform(21.1,22.2,1,1,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.arrow).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-3.1,260.3,45.6);
...
(lib.ctasignupon = function(mode,startPosition,loop) {
	...
	this.cta_label.setTransform(181.4,34.8,0.96,0.96,0,0,0,137.4,26);
	this.cta_label.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 255, 255, 0)];
	this.cta_label.cache(-2,-5,264,50);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_3.cache(35,42,446,98);
	...
	this.text_2.cache(91,26,358,125);
	...
	this.text_1.cache(45,31,448,119);
