...
(lib.ctalabelsignup = function(mode,startPosition,loop) {
	...
	this.shape_4.setTransform(188.7,17.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#002F53").s().p("AgcCtIAAlZIA5AAIAAFZg");
	this.shape_5.setTransform(169.7,17.8);
	...
	this.shape_6.setTransform(151.6,17.8);
	...
	this.shape_7.setTransform(126.9,17.8);
...
p.nominalBounds = new cjs.Rectangle(0,-10,259.9,46.2);
...
(lib.ctasignupon = function(mode,startPosition,loop) {
	...
	this.cta_label.setTransform(179.2,39.9,0.96,0.96,0,0,0,137.4,26);
	this.cta_label.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 255, 255, 0)];
	this.cta_label.cache(-2,-12,264,50);
