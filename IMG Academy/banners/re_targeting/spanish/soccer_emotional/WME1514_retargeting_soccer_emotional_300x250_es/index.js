...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete1.png?1481833850093", id:"img_athlete1"},
		{src:"images/img_athlete2.png?1481833850093", id:"img_athlete2"},
		{src:"images/img_facilities.png?1481833850093", id:"img_facilities"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(25,89,549.2,116.3);
...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(199,116.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(31.1,31.5,336,169.2);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(200,117);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(29,16,342,202.1);
...
p.nominalBounds = new cjs.Rectangle(325,0,275.3,448.2);
...
p.nominalBounds = new cjs.Rectangle(363,11,235.4,469.4);
...
p.nominalBounds = new cjs.Rectangle(0,-5.6,260.8,45.2);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(29,30,340,173);
	...
	this.text_1.cache(27,14,346,206);
