...
(function() {
    ...
    */
    var banner = document.getElementById('banner'),
        ...
        phone_left = document.getElementsByClassName('phone-left'),
        phone_right = document.getElementsByClassName('phone-right'),
    ...
    */
    ...
    TweenMax.set(logo, {scale:0.23, z:0.1, rotationZ:0.01, force3D:true});
