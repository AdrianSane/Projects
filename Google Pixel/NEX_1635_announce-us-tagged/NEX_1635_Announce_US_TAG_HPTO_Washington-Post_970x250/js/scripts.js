...
(function() {
    ...
    */
    var banner = document.getElementById('banner'),
        ...
        carrier = document.getElementsByClassName('carrier')[0],
        ...
        endFrameAssets = [cta, headline, carrier],
    ...
    */
    ...
    mainTl
        ...
        // animate search bar
        .to(search, 2.5, {borderRadius:12, x:205, y:-82, width:99, height:203, ease: Sine.easeOut})
        .to(search, .25, {opacity:0, ease: Sine.easeIn}, "+=.5")

        // reveal pixel
        .to(phone, .75, {autoAlpha:1, ease: Sine.easeIn, onComplete:endFrame}, "-=.5");
        ...
        function endFrame(){
          ...
          // show carrier logo (if any)
          .from(carrier, 1, {autoAlpha:0, ease: Sine.easeOut}, "-=2")

          // show cta
          .fromTo(cta, 1, {scale:1.05, autoAlpha:0}, {scale:1, autoAlpha:1, ease:Back.easeInOut.config(0.8)}, "-=3");
        }
