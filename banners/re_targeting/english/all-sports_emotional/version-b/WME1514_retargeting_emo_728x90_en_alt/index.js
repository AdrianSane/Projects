...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(343.2,134.2,0.292,0.292);
	...
	this.shape_1.setTransform(318.5,134.2,0.292,0.292);
	...
	this.shape_2.setTransform(298.4,134.3,0.292,0.292);
	...
	this.shape_3.setTransform(277.3,134.3,0.292,0.292);
	...
	this.shape_10.setTransform(204.9,69.3,0.292,0.292);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(311.6,118.3,0.227,0.227);
	...
	this.shape_6.setTransform(247.1,51.5,0.227,0.227);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ai5RAIAA85IlqAAIAAlGIRHAAIAAFGIlqAAIAAc5g");
	this.shape_7.setTransform(217.1,51.5,0.227,0.227);
...
(lib.ctalabelregistertoday = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#002F53").s().p("");
	this.shape.setTransform(214,19.3);
...
p.nominalBounds = new cjs.Rectangle(0,1.5,356.2,37.5);
...
(lib.ctaregistertodayon = function(mode,startPosition,loop) {
	...
	this.cta_label.setTransform(140,34.5,0.786,0.786,0,0,0,137.3,25.9);
	this.cta_label.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 255, 255, 0)];
	this.cta_label.cache(-2,0,360,42);
