...
p.nominalBounds = new cjs.Rectangle(0,0,327,635);
...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(516,208.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(462.9,208.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AjgHWIAAurIGvAAIAACNIkNAAIAADyIDPAAIAACMIjPAAIAAETIEfAAIAACNg");
	this.shape_2.setTransform(411.6,208.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("ABrHWIjNpKIgDAAIAAJKIiRAAIAAurICVAAIDEIYIADAAIAAoYICRAAIAAOrg");
	this.shape_3.setTransform(353.5,208.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhQHWIAAseIicAAIAAiNIHZAAIAACNIidAAIAAMeg");
	this.shape_4.setTransform(300.3,208.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AB0HWIgcjQIiwAAIgdDQIibAAICsurIDHAAICuOrgABAB5Ig/mSIgCAAIg/GSICAAAg");
	this.shape_5.setTransform(250.8,208.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AjgHWIAAurIGvAAIAACNIkNAAIAADyIDPAAIAACMIjPAAIAAETIEfAAIAACNg");
	this.shape_6.setTransform(199.1,208.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("ABhHWIhxmFIhTAEIAAGBIihAAIAAurIDiAAQBEABAyAPQA0AQAhAgQAiAiASA0QARA1AABLQAAA2gKArQgJAngRAdQgPAagWASQgRAQgXAKICIGqgAhjgvIA5AAQAiAAAUgHQAYgHAOgQQAOgRAGgcQAHgbAAgqQAAgqgHgbQgGgdgOgQQgOgQgYgIQgUgHgiAAIg5AAg");
	this.shape_7.setTransform(142.3,208.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(80.1,208.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhuHTQgtgSgggiQgfgggPgtQgPgrAAgzIAAnnQAAgyAPgsQAPgsAfghQAggiAtgRQAxgUA9AAQA+AAAwAUQAuARAgAiQAfAhAPAsQAPAsAAAyIAAHnQAAAzgPArQgPAtgfAgQggAiguASQgwATg+AAQg9AAgxgTgAhDk9QgTAXAAA4IAAHdQAAA4ATAYQAUAaAvAAQAwAAAUgaQASgYAAg4IAAndQAAg4gSgXQgUgagwgBQgvABgUAag");
	this.shape_9.setTransform(514.1,95.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AhRHZIAAsjIicAAIAAiOIHbAAIAACOIidAAIAAMjg");
	this.shape_10.setTransform(459.3,95.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhRHZIAAsjIicAAIAAiOIHbAAIAACOIidAAIAAMjg");
	this.shape_11.setTransform(386.3,95.3);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AhQHZIAAuxIChAAIAAOxg");
	this.shape_12.setTransform(346.2,95.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AC9HZIAAriIgDAAIiTLiIhOAAIiSriIgDAAIAALiIiNAAIAAuxIDVAAIB0IoIABAAIBzooIDWAAIAAOxg");
	this.shape_13.setTransform(291.5,95.3);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AC9HZIAAriIgDAAIiTLiIhOAAIiSriIgDAAIAALiIiNAAIAAuxIDVAAIB0IoIABAAIBzooIDWAAIAAOxg");
	this.shape_14.setTransform(215,95.3);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AhtHTQgvgSgfgiQgfgggPgtQgPgrAAgzIAAnnQAAgyAPgsQAPgsAfghQAfgiAvgRQAwgUA9AAQA+AAAwAUQAvARAfAiQAfAhAPAsQAPAsAAAyIAAHnQAAAzgPArQgPAtgfAgQgfAigvASQgwATg+AAQg9AAgwgTgAhDk9QgSAXgBA4IAAHdQABA4ASAYQAUAaAvAAQAwAAAUgaQASgYABg4IAAndQgBg4gSgXQgUgagwgBQgvABgUAag");
	this.shape_15.setTransform(145.8,95.3);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("");
	this.shape_16.setTransform(83.4,95.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline2, new cjs.Rectangle(46,46,499.6,248), null);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(512.5,208.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AB+IsIjzq2IgCAAIAAK2IisAAIAAxXICwAAIDoJ7IADAAIAAp7ICtAAIAARXg");
	this.shape_1.setTransform(440.2,208.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhfIsIAAxXIC+AAIAARXg");
	this.shape_2.setTransform(384.5,208.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AB+IsIjzq2IgCAAIAAK2IisAAIAAxXICwAAIDoJ7IAEAAIAAp7ICsAAIAARXg");
	this.shape_3.setTransform(328.8,208.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhfIsIAAxXIC/AAIAARXg");
	this.shape_4.setTransform(273.1,208.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("ACKIsIgij2IjQAAIgiD2Ii4AAIDMxXIDsAAIDNRXgABNCPIhMndIgCAAIhMHdICaAAg");
	this.shape_5.setTransform(221.7,208.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("ABzIsIiGnMIhjAEIAAHIIi/AAIAAxXIEMAAQBRAAA8ASQA8ASApAnQAoAoAUA9QAVA/AABZQAABBgMAzQgLAugVAiQgQAfgaAWQgWASgbAMICiH4gAh2g4IBEAAQAoAAAYgIQAcgIARgUQARgTAHgiQAIggAAgyQAAgygIggQgHghgRgUQgRgUgcgHQgYgJgoAAIhEAAg");
	this.shape_6.setTransform(154.9,208.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhfIsIAAuwIi4AAIAAinIIvAAIAACnIi5AAIAAOwg");
	this.shape_7.setTransform(88.9,208.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhwHaQgugSgggjQgfgggQguQgOgsAAgzIAAnuQAAg0AOgsQAQgtAfghQAggjAugSQAygTA+AAQA/AAAxATQAvASAgAjQAfAhAPAtQAPAsABA0IAAHuQgBAzgPAsQgPAugfAgQggAjgvASQgxATg/AAQg+AAgygTgAhElCQgTAYABA4IAAHlQgBA4ATAZQAVAaAvAAQAwAAAVgaQASgZAAg4IAAnlQAAg4gSgYQgVgbgwAAQgvAAgVAbg");
	this.shape_8.setTransform(518.6,85);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhRHgIAAsvIigAAIAAiQIHjAAIAACQIigAAIAAMvg");
	this.shape_9.setTransform(463.5,85);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AhSHgIAAsvIifAAIAAiQIHjAAIAACQIifAAIAAMvg");
	this.shape_10.setTransform(390.3,85);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhSHgIAAu/IClAAIAAO/g");
	this.shape_11.setTransform(350,85);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("ADAHgIAArtIgEAAIiVLtIhPAAIiUrtIgDAAIAALtIiPAAIAAu/IDYAAIB1IxIACAAIB1oxIDZAAIAAO/g");
	this.shape_12.setTransform(294.9,85);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("ADAHgIAArtIgEAAIiULtIhPAAIiVrtIgDAAIAALtIiPAAIAAu/IDYAAIB1IxIACAAIB1oxIDZAAIAAO/g");
	this.shape_13.setTransform(217.6,85);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhvHaQgvgSgggjQgfgggPguQgPgsgBgzIAAnuQABg0APgsQAPgtAfghQAggjAvgSQAxgTA+AAQA/AAAyATQAuASAgAjQAfAhAQAtQAPAsgBA0IAAHuQABAzgPAsQgQAugfAgQggAjguASQgyATg/AAQg+AAgxgTgAhElCQgSAYgBA4IAAHlQABA4ASAZQAVAaAvAAQAwAAAVgaQATgZAAg4IAAnlQAAg4gTgYQgVgbgwAAQgvAAgVAbg");
	this.shape_14.setTransform(147.8,85);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(84.9,85);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline1, new cjs.Rectangle(50,35,500.1,274), null);
...
(lib.imgathlete1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(165,356,1.33,1.33);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.imgathlete1, new cjs.Rectangle(165,356,434.9,844.5), null);
...
(lib.ctafindoutmore = function(mode,startPosition,loop) {
	...
	// cta-off
	this.cta_off = new lib.ctasignupon();
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(44,44,504,252);
	...
	this.text_1.cache(48,33,504,278);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete.png?1481828112439", id:"img_athlete"},
		{src:"images/img_facilities.png?1481828112439", id:"img_facilities"}
	],
	preloads: []
};
