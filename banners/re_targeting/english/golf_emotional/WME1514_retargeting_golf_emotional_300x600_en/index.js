...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhVH2IAAtUIinAAIAAiXIH5AAIAACXIinAAIAANUg");
	this.shape.setTransform(492.4,221.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(436.9,221.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AjvH2IAAvrIHMAAIAACXIkgAAIAAECIDeAAIAACVIjeAAIAAEnIEzAAIAACWg");
	this.shape_2.setTransform(380,221.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(316.4,221.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AjvH2IAAvrIHMAAIAACXIkgAAIAAECIDeAAIAACVIjeAAIAAEnIEzAAIAACWg");
	this.shape_4.setTransform(226.3,221.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("ABcH2IAAm9Ii3AAIAAG9IisAAIAAvrICsAAIAAGZIC3AAIAAmZICsAAIAAPrg");
	this.shape_5.setTransform(162,221.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhVH2IAAtUIinAAIAAiXIH5AAIAACXIinAAIAANUg");
	this.shape_6.setTransform(103,221.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AkWJFIAAyJIIWAAIAACuIlOAAIAAErIEBAAIAACtIkBAAIAAFWIFlAAIAACtg");
	this.shape_7.setTransform(491.8,88.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("ADoJFIAAuLIgEAAIi0OLIhgAAIi0uLIgDAAIAAOLIiuAAIAAyJIEGAAICPKnIACAAICNqnIEHAAIAASJg");
	this.shape_8.setTransform(410.1,88.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AiHI+Qg4gVgngrQgmgngTg3QgSg2AAg+IAApWQAAg/ASg2QATg1AmgoQAngrA4gVQA7gYBMAAQBNAAA7AYQA4AVAnArQAmAoASA1QATA2AAA/IAAJWQAAA+gTA2QgSA3gmAnQgnArg4AVQg7AXhNAAQhMAAg7gXgAhTmGQgWAdAABEIAAJLQAABEAWAeQAZAgA6gBQA7ABAZggQAWgeAAhEIAApLQAAhEgWgdQgZggg7AAQg6AAgZAgg");
	this.shape_9.setTransform(325.7,88.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("");
	this.shape_10.setTransform(249.7,88.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AkVJFIAAyJIIVAAIAACuIlNAAIAAErIEAAAIAACtIkAAAIAAFWIFkAAIAACtg");
	this.shape_11.setTransform(181,88.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("");
	this.shape_12.setTransform(109.1,88.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline2, new cjs.Rectangle(66,28,457,284), null);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(458.4,237.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(420.7,237.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AilFbIAAq1IE+AAIAABpIjHAAIAACyICZAAIAABnIiZAAIAADLIDUAAIAABog");
	this.shape_2.setTransform(381.9,237.6);
	...
	this.shape_3.setTransform(338.5,237.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("ABIFbIhUkfIg9ADIAAEcIh3AAIAAq1ICnAAQAyAAAlAMQAmALAZAYQAaAZAMAnQAMAnAAA3QAAAogGAgQgIAdgMAVQgLATgQANQgNAMgRAIIBlE6gAhJgiIAqAAQAZAAAPgFQASgGAKgMQAKgMAFgVQAEgUAAgfQAAgfgEgUQgFgVgKgMQgKgMgSgFQgPgGgZAAIgqAAg");
	this.shape_4.setTransform(274.8,237.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhMFUQghgMgXgYQgYgXgMgjQgOgjAAgsIAAoGIB4AAIAAILQAAAnAPASQAQATAfAAQAhAAAPgTQAQgSAAgnIAAoLIB3AAIAAIGQgBAsgNAjQgLAjgZAXQgXAYgiAMQgiAMgqgBQgpABgjgMg");
	this.shape_5.setTransform(228.3,238.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhQFWQgigNgXgZQgWgXgMghQgLghABgkIAAllQgBglALggQAMggAWgYQAXgZAigNQAjgOAtAAQAtAAAkAOQAiANAXAZQAXAYAKAgQALAgAAAlIAAFlQAAAkgLAhQgKAhgXAXQgXAZgiANQgkAOgtAAQgtAAgjgOgAgwjpQgOASgBApIAAFeQABAoAOARQAOATAiAAQAjAAAPgTQAOgRgBgoIAAleQABgpgOgSQgPgSgjgBQgiABgOASg");
	this.shape_6.setTransform(182.8,237.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ag6FbIAAkgIiQmVIB5AAIBSEJIACAAIBQkJIB4AAIiPGVIAAEgg");
	this.shape_7.setTransform(140,237.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AiGMQIAA0zIkEAAIAAjrIMVAAIAADrIkFAAIAAUzg");
	this.shape_8.setTransform(437.6,108.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("ADDMQIgvlcIknAAIgwFcIkDAAIEg4eIFMAAIEhYegABsDKIhqqgIgDAAIhrKgIDYAAg");
	this.shape_9.setTransform(352.4,108.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("Al2MQIAA4eILQAAIAADrInDAAIAAGTIFaAAIAADqIlaAAIAAHMIHgAAIAADqg");
	this.shape_10.setTransform(263.4,108.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(164.7,108.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline1, new cjs.Rectangle(107.4,28,369.7,273), null);
...
(lib.imgathlete2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-182,389,1.33,1.33);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.imgathlete2, new cjs.Rectangle(-182,389,782,808.6), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(64,26,461,288);
	...
	this.text_1.cache(105,26,374,277);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete1.png?1481825746701", id:"img_athlete1"},
		{src:"images/img_athlete2.png?1481825746701", id:"img_athlete2"},
		{src:"images/img_facilities.png?1481825746701", id:"img_facilities"}
	],
	preloads: []
};
