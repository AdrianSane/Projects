...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ag1E6IAAoVIhoAAIAAheIE7AAIAABeIhoAAIAAIVg");
	this.shape.setTransform(423.3,117.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(388.4,117.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AiVE6IAApzIEfAAIAABeIi0AAIAACiICLAAIAABdIiLAAIAAC4IDAAAIAABeg");
	this.shape_2.setTransform(352.5,117.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(312.4,117.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AiVE6IAApzIEfAAIAABeIi0AAIAACiICLAAIAABdIiLAAIAAC4IDAAAIAABeg");
	this.shape_4.setTransform(255.6,117.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AA5E6IAAkWIhxAAIAAEWIhsAAIAApzIBsAAIAAEAIBxAAIAAkAIBsAAIAAJzg");
	this.shape_5.setTransform(215.1,117.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ag1E6IAAoVIhoAAIAAheIE7AAIAABeIhoAAIAAIVg");
	this.shape_6.setTransform(177.9,117.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("ABfDuIAAlzIgBAAIhKFzIgnAAIhKlzIgBAAIAAFzIhHAAIAAnbIBrAAIA6EVIABAAIA6kVIBrAAIAAHbg");
	this.shape_7.setTransform(422.2,51.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("Ag3DrQgXgJgPgRQgQgQgIgXQgHgWgBgZIAAj1QABgZAHgWQAIgXAQgQQAPgRAXgJQAYgKAfAAQAfAAAZAKQAXAJAQARQAPAQAIAXQAHAWAAAZIAAD1QAAAZgHAWQgIAXgPAQQgQARgXAJQgZAKgfAAQgfAAgYgKgAghifQgKAMAAAbIAADxQAAAbAKANQAKAMAXAAQAYAAAKgMQAKgNAAgbIAAjxQAAgbgKgMQgKgOgYAAQgXAAgKAOg");
	this.shape_8.setTransform(387.5,51.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAxDuIg5jFIgqACIAADDIhSAAIAAnbIBzAAQAiAAAaAHQAaAIARARQARARAJAaQAJAbAAAmQAAAcgFAWQgFATgJAPQgHANgLAJQgJAIgMAFIBGDYgAgygXIAdAAQARAAAKgEQAMgDAHgJQAHgIAEgOQADgOAAgWQAAgVgDgOQgEgOgHgJQgHgIgMgDQgKgEgRAAIgdAAg");
	this.shape_9.setTransform(357.1,51.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AhxDuIAAnbIDjAAIAABHIiRAAIAAB7IBsAAIAABGIhsAAIAADTg");
	this.shape_10.setTransform(327.9,51.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AA2DuIhokpIgBAAIAAEpIhJAAIAAnbIBLAAIBjEPIACAAIAAkPIBKAAIAAHbg");
	this.shape_11.setTransform(285.2,51.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAxDuIg5jFIgqACIAADDIhSAAIAAnbIBzAAQAiAAAaAHQAaAIARARQARARAJAaQAJAbAAAmQAAAcgFAWQgFATgJAPQgHANgLAJQgJAIgMAFIBGDYgAgygXIAdAAQARAAAKgEQAMgDAHgJQAHgIAEgOQADgOAAgWQAAgVgDgOQgEgOgHgJQgHgIgMgDQgKgEgRAAIgdAAg");
	this.shape_12.setTransform(254.8,51.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AA8DuIgPhpIhZAAIgOBpIhPAAIBXnbIBlAAIBYHbgAAhA9IggjLIgBAAIggDLIBBAAg");
	this.shape_13.setTransform(224.8,51.8);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhxDuIAAnbIDaAAIAABHIiIAAIAAB7IBoAAIAABGIhoAAIAACMICRAAIAABHg");
	this.shape_14.setTransform(198.1,51.8);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AhoDuIAAnbIBRAAIAAGUICAAAIAABHg");
	this.shape_15.setTransform(173.1,51.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline2, new cjs.Rectangle(157,26,285.7,149), null);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ag0EvIAAoCIhkAAIAAhbIExAAIAABbIhlAAIAAICg");
	this.shape.setTransform(418.9,118.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(385,118.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AiQEvIAApdIEWAAIAABbIiuAAIAACcICFAAIAABaIiFAAIAACyIC5AAIAABag");
	this.shape_2.setTransform(350.1,118.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(311.1,118.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AiQEvIAApdIEWAAIAABbIiuAAIAACcICFAAIAABaIiFAAIAACyIC5AAIAABag");
	this.shape_4.setTransform(255.8,118.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AA4EvIAAkMIhvAAIAAEMIhnAAIAApdIBnAAIAAD3IBvAAIAAj3IBnAAIAAJdg");
	this.shape_5.setTransform(216.5,118.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ag0EvIAAoCIhkAAIAAhbIExAAIAABbIhlAAIAAICg");
	this.shape_6.setTransform(180.3,118.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAtD2IAAjaIhZAAIAADaIhUAAIAAnrIBUAAIAADIIBZAAIAAjIIBUAAIAAHrg");
	this.shape_7.setTransform(421.3,53.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgqD2IAAmhIhRAAIAAhKID3AAIAABKIhSAAIAAGhg");
	this.shape_8.setTransform(392,53.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgpD2IAAnrIBTAAIAAHrg");
	this.shape_9.setTransform(370.4,53.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AA/D2Ig9lEIgBAAIg4FEIhHAAIhdnrIBPAAIAzE4IACAAIA3k4IBEAAIA5E4IACAAIAvk4IBOAAIhWHrg");
	this.shape_10.setTransform(338.6,53.6);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AA4D2IhrkyIgBAAIAAEyIhMAAIAAnrIBOAAIBmEYIABAAIAAkYIBMAAIAAHrg");
	this.shape_11.setTransform(286.5,53.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgpD2IAAnrIBTAAIAAHrg");
	this.shape_12.setTransform(261.1,53.6);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AA9D2IgPhtIhcAAIgPBtIhRAAIBanrIBoAAIBbHrgAAiA/IgijSIAAAAIghDSIBDAAg");
	this.shape_13.setTransform(237.6,53.6);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AAzD2Ig7jMIgrACIAADKIhUAAIAAnrIB2AAQAiABAbAHQAbAJASARQARARAKAcQAIAbABAnQgBAcgFAXQgEAUgKAQQgHANgMAKQgJAHgMAGIBIDfgAgzgYIAdAAQASAAAKgEQANgDAHgJQAIgJADgPQADgOAAgWQAAgVgDgPQgDgOgIgJQgHgJgNgEQgKgDgSAAIgdAAg");
	this.shape_14.setTransform(207.2,53.6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgpD2IAAmhIhRAAIAAhKID1AAIAABKIhRAAIAAGhg");
	this.shape_15.setTransform(177.2,53.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline1, new cjs.Rectangle(162,27,277.5,147), null);
...
}).prototype = getMCSymbolPrototype(lib.imgathlete1, new cjs.Rectangle(659,0,214.1,180.9), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(155,24,290,153);
	...
	this.text_1.cache(160,25,282,151);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete.png?1481828663648", id:"img_athlete"},
		{src:"images/img_facilities.png?1481828663648", id:"img_facilities"}
	],
	preloads: []
};
