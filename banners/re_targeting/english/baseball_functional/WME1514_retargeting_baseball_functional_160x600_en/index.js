...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ag0EzIAAoIIhlAAIAAhdIEzAAIAABdIhmAAIAAIIg");
	this.shape.setTransform(274.2,177.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(241.5,177.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AiSEzIAAplIEaAAIAABdIiwAAIAACdICGAAIAABbIiGAAIAAC0IC7AAIAABcg");
	this.shape_2.setTransform(207.9,177.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(170.2,177.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AiSEzIAAplIEaAAIAABdIiwAAIAACdICGAAIAABbIiGAAIAAC0IC7AAIAABcg");
	this.shape_4.setTransform(117.6,177.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AA4EzIAAkQIhvAAIAAEQIhpAAIAAplIBpAAIAAD6IBvAAIAAj6IBqAAIAAJlg");
	this.shape_5.setTransform(79.4,177.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ag0EzIAAoIIhlAAIAAhdIEzAAIAABdIhlAAIAAIIg");
	this.shape_6.setTransform(44.5,177.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("ABcDnIAAloIgBAAIhIFoIglAAIhIloIgBAAIAAFoIhFAAIAAnNIBoAAIA4ENIABAAIA4kNIBoAAIAAHNg");
	this.shape_7.setTransform(274.4,115.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("Ag1DkQgXgIgPgRQgPgQgHgWQgIgVABgZIAAjtQgBgZAIgVQAHgWAPgPQAPgSAXgIQAYgJAdgBQAeABAYAJQAWAIAQASQAPAPAHAWQAIAVAAAZIAADtQAAAZgIAVQgHAWgPAQQgQARgWAIQgYAKgeAAQgdAAgYgKgAggibQgJAMAAAbIAADpQAAAbAJAMQAKAMAWAAQAYAAAJgMQAJgMAAgbIAAjpQAAgbgJgMQgJgMgYAAQgWAAgKAMg");
	this.shape_8.setTransform(241.5,115.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAwDnIg3i/IgpACIAAC9IhQAAIAAnNIBvAAQAiAAAYAIQAaAHARAQQAQAQAIAbQAJAZAAAmQAAAagEAVQgFATgJAPQgHAMgLAJQgIAHgMAGIBEDRgAgwgWIAcAAQARgBAJgDQALgDAHgJQAIgIACgNQADgOABgUQgBgWgDgNQgCgNgIgJQgHgIgLgEQgJgDgRAAIgcAAg");
	this.shape_9.setTransform(212.8,115.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AhuDnIAAnNIDcAAIAABFIiMAAIAAB3IBpAAIAABEIhpAAIAADNg");
	this.shape_10.setTransform(185.2,115.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AA0DnIhkkgIgBAAIAAEgIhHAAIAAnNIBJAAIBgEHIABAAIAAkHIBIAAIAAHNg");
	this.shape_11.setTransform(145.3,115.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAwDnIg3i/IgpACIAAC9IhQAAIAAnNIBwAAQAhAAAYAIQAaAHARAQQAQAQAJAbQAIAZAAAmQAAAagEAVQgFATgIAPQgIAMgKAJQgKAHgLAGIBEDRgAgwgWIAcAAQAQgBAKgDQAMgDAGgJQAIgIACgNQAEgOAAgUQAAgWgEgNQgCgNgIgJQgGgIgMgEQgKgDgQAAIgcAAg");
	this.shape_12.setTransform(116.6,115.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AA5DnIgOhmIhWAAIgOBmIhMAAIBVnNIBhAAIBVHNgAAgA7IgfjFIgBAAIgfDFIA/AAg");
	this.shape_13.setTransform(88.3,115.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhtDnIAAnNIDTAAIAABFIiEAAIAAB3IBlAAIAABEIhlAAIAACIICMAAIAABFg");
	this.shape_14.setTransform(63.2,115.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AhlDnIAAnNIBPAAIAAGIIB8AAIAABFg");
	this.shape_15.setTransform(39.7,115.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline2, new cjs.Rectangle(24,90,269.6,144), null);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(278.9,180);
	...
	this.shape_3.setTransform(172.4,180);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AiPEsIAApXIETAAIAABaIirAAIAACaICDAAIAABZIiDAAIAACwIC2AAIAABag");
	this.shape_4.setTransform(117.7,180);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AA2EsIAAkKIhsAAIAAEKIhmAAIAApXIBmAAIAAD0IBsAAIAAj0IBoAAIAAJXg");
	this.shape_5.setTransform(78.8,180);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgyEsIAAn9IhkAAIAAhaIEtAAIAABaIhkAAIAAH9g");
	this.shape_6.setTransform(43.1,180);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAsDyIAAjXIhXAAIAADXIhUAAIAAnjIBUAAIAADFIBXAAIAAjFIBUAAIAAHjg");
	this.shape_7.setTransform(281.3,116.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgoDyIAAmaIhRAAIAAhJIDzAAIAABJIhRAAIAAGag");
	this.shape_8.setTransform(252.5,116.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgpDyIAAnjIBTAAIAAHjg");
	this.shape_9.setTransform(231.2,116.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AA/DyIg9k/IgBAAIg4E/IhFAAIhcnjIBOAAIAzEzIABAAIA2kzIBEAAIA4EzIABAAIAukzIBOAAIhVHjg");
	this.shape_10.setTransform(199.9,116.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AA3DyIhpkuIgBAAIAAEuIhMAAIAAnjIBOAAIBkEUIABAAIAAkUIBMAAIAAHjg");
	this.shape_11.setTransform(148.6,116.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgpDyIAAnjIBTAAIAAHjg");
	this.shape_12.setTransform(123.6,116.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AA8DyIgOhsIhbAAIgOBsIhRAAIBZnjIBmAAIBaHjgAAhA/IggjPIgBAAIghDPIBCAAg");
	this.shape_13.setTransform(100.4,116.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AAyDyIg6jIIgqACIAADGIhUAAIAAnjIB1AAQAjAAAZAIQAbAIARARQASARAJAbQAJAbAAAnQAAAcgFAWQgFAUgJAPQgIANgLAJQgJAJgMAFIBHDbgAgygYIAdAAQARABAKgEQANgEAHgIQAHgJADgOQAEgPAAgVQAAgWgEgOQgDgPgHgIQgHgJgNgDQgKgEgRABIgdAAg");
	this.shape_14.setTransform(70.5,116.2);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgpDyIAAmaIhQAAIAAhJIDzAAIAABJIhQAAIAAGag");
	this.shape_15.setTransform(41,116.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline1, new cjs.Rectangle(25,90,274.2,145), null);
...
(lib.imgathlete1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,251,1.33,1.33);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.imgathlete1, new cjs.Rectangle(0,251,319.2,947), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(22,88,274,148);
	...
	this.text_1.cache(23,88,278,149);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/BlueGradientImage.png?1481829047285", id:"BlueGradientImage"},
		{src:"images/img_athlete.png?1481829047285", id:"img_athlete"},
		{src:"images/img_facilities.png?1481829047285", id:"img_facilities"}
	],
	preloads: []
};
