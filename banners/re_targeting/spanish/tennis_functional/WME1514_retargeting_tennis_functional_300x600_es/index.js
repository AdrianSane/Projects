...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	this.shape_2.setTransform(491.7,188.6,0.782,0.782);
	...
	this.shape_19.setTransform(110.9,77.2,0.782,0.782);
	...
	this.shape_20.setTransform(77.9,77.2,0.782,0.782);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline2, new cjs.Rectangle(65,37,469.4,230.4), null);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AkNJcQhdhrgHimIDkggQAIBnAnA3QAlA1A7AAQBAAAAlghQAngiAAg9QAAhbhNhXQgggliHhzQh0hhg0hNQhMhwAAiIQAAimBhhbQBihbCwAAQCPAABZBfQBVBaARCZIjlAaQgHhSgogpQghgggwAAQg5gBgfAlQgfAkAABBQAABOBMBUQAbAdCMB7QBzBjA1BOQBMByAACAQAACphpBgQhmBeisAAQihAAhjh0g");
	this.shape.setTransform(511.5,180.6,0.8,0.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AlOK8IAA13IKCAAIAADRImSAAIAAFpIE1AAIAADRIk1AAIAAGbIGtAAIAADRg");
	this.shape_1.setTransform(444.7,180.6,0.8,0.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ACRK8IippEQgvAGhNAAIAAI+IjxAAIAA13IFSAAQDOAABhBeQBnBkAADbQAACag2BdQgqBIhJAhIDMJ6gAiUhHIBVAAQBiAAAngtQAogvAAh7QAAh7gogvQgngthiAAIhVAAg");
	this.shape_2.setTransform(372.9,180.6,0.8,0.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AkVJnQhbhhABidIAArRQgBidBbhhQBihoCzAAQC1AABiBoQBaBhAACdIAALRQAACdhaBhQhiBpi1AAQizAAhihpgAhjnXQgcAjAABSIAALEQAABSAcAjQAeAnBFAAQBHAAAegnQAbgjAAhSIAArEQAAhSgbgjQgegmhHAAQhFAAgeAmg");
	this.shape_3.setTransform(296.4,180.6,0.8,0.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AjPLGIAAjRIAyAAQBEAAAegdQAcgcAAg8IAAxFIDvAAIAARgQAACShFBHQhQBSi7AAg");
	this.shape_4.setTransform(234.7,181.4,0.8,0.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AlPK8IAA13IKEAAIAADRImTAAIAAFpIE1AAIAADRIk1AAIAAGbIGuAAIAADRg");
	this.shape_5.setTransform(181.9,180.6,0.8,0.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AEXK8IAAxFIgEAAIjZRFIhzAAIjZxFIgEAAIAARFIjSAAIAA13IE8AAICrMxIADAAICrsxIE8AAIAAV3g");
	this.shape_6.setTransform(100.3,180.6,0.8,0.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AiEErQgug2gEhRIBxgQQAEAzATAbQATAaAcAAQAgAAASgQQATgRAAgeQAAgtglgrQgRgShBg5Qg6gwgaglQgmg4AAhDQAAhTAxgtQAwgsBXgBQBHAAArAwQAqAsAJBNIhyAMQgDgpgUgUQgQgQgYAAQgbAAgQASQgPARAAAhQAAAmAmAqQANAPBEA8QA5AwAaAnQAmA4AAA/QAABUg0AwQgzAthTAAQhQAAgxg4g");
	this.shape_7.setTransform(527.8,86.5,0.801,0.801);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AiIEvQgtgvAAhOIAAljQAAhOAtgvQAwg1BYAAQBZAAAwA1QAtAvAABOIAAFjQAABOgtAvQgwA1hZgBQhYABgwg1gAgwjoQgOASAAAoIAAFdQAAApAOARQAOATAiAAQAjAAAPgTQANgRAAgpIAAldQAAgogNgSQgPgTgjAAQgiAAgOATg");
	this.shape_8.setTransform(492.2,86.5,0.801,0.801);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AiYFaIAAqzIB3AAIAAJLIC6AAIAABog");
	this.shape_9.setTransform(459.7,86.5,0.801,0.801);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("ABPFaIiWmvIgCAAIAAGvIhsAAIAAqzIBvAAICPGLIACAAIAAmLIBrAAIAAKzg");
	this.shape_10.setTransform(410.1,86.5,0.801,0.801);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AiJEvQgsgvAAhOIAAljQAAhOAsgvQAxg1BYAAQBZAAAxA1QAsAvAABOIAAFjQAABOgsAvQgxA1hZgBQhYABgxg1gAgxjoQgNASAAAoIAAFdQAAApANARQAPATAiAAQAjAAAOgTQAOgRAAgpIAAldQAAgogOgSQgOgTgjAAQgiAAgPATg");
	this.shape_11.setTransform(373.2,86.5,0.801,0.801);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AiGEvQgsgvAAhOIAAljQAAhOAsgvQAxg1BYAAQBVAAAwA4QArA0AABSIAAAzIh3AAIAAg1QAAgqgRgWQgPgUgZAAQgiAAgPATQgOASABAoIAAFdQgBApAOARQAPATAiAAQAfAAAOgSQAMgQAAgkIAAhTIB3AAIAABPQAABOgrAvQgwA1hVgBQhYABgxg1g");
	this.shape_12.setTransform(336.3,86.5,0.801,0.801);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("ABWFaIgViaIiBAAIgVCaIhzAAIB/qzICTAAIB/KzgAgvBZIBfAAIgvkoIgBAAg");
	this.shape_13.setTransform(286.4,86.5,0.801,0.801);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("ABOFaIiWmvIgCAAIAAGvIhrAAIAAqzIBuAAICQGLIACAAIAAmLIBrAAIAAKzg");
	this.shape_14.setTransform(249.9,86.5,0.801,0.801);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AilFaIAAqzIE9AAIAABoIjGAAIAACyICYAAIAABmIiYAAIAADLIDUAAIAABog");
	this.shape_15.setTransform(215.2,86.5,0.801,0.801);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("ABIFaIhTkfQgXADgmAAIAAEcIh3AAIAAqzICmAAQBmAAAwAvQAzAxAABsQAACJhUAkIBkE6gAhIgjIAqAAQAvAAATgWQAVgXgBg9QABg9gVgXQgTgWgvAAIgqAAg");
	this.shape_16.setTransform(179.6,86.5,0.801,0.801);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("Ag6FaIAApLIhzAAIAAhoIFbAAIAABoIhzAAIAAJLg");
	this.shape_17.setTransform(144.4,86.5,0.801,0.801);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("ABOFaIiWmvIgCAAIAAGvIhrAAIAAqzIBuAAICQGLIACAAIAAmLIBrAAIAAKzg");
	this.shape_18.setTransform(110,86.5,0.801,0.801);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AilFaIAAqzIE9AAIAABoIjGAAIAACyICYAAIAABmIiYAAIAADLIDUAAIAABog");
	this.shape_19.setTransform(75.4,86.5,0.801,0.801);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.textheadline1, new cjs.Rectangle(61.2,58.1,481.3,180.1), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(63,35,473,234);
	...
	this.text_1.cache(59,56,485,184);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete.png?1481841811675", id:"img_athlete"},
		{src:"images/img_facilities.png?1481841811675", id:"img_facilities"}
	],
	preloads: []
};
