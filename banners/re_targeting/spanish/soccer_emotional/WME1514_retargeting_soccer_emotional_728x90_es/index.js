...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete1.png?1481833671167", id:"img_athlete1"},
		{src:"images/img_athlete2.png?1481833671167", id:"img_athlete2"},
		{src:"images/img_facilities.png?1481833671167", id:"img_facilities"}
	]
};
...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(224.1,83);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(89.1,15,270,136);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(226,84,0.37,0.37,0,0,0,-0.1,0.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(115.1,18.3,222,131.1);
...
p.nominalBounds = new cjs.Rectangle(670,0,172,181.4);
...
p.nominalBounds = new cjs.Rectangle(722,0,142.6,181.4);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(87,13,274,140);
	...
	this.text_1.cache(113,16,226,135);
