...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img_athlete1.png?1481833988451", id:"img_athlete1"},
		{src:"images/img_athlete2.png?1481833988451", id:"img_athlete2"},
		{src:"images/img_facilities.png?1481833988451", id:"img_facilities"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(44.8,348.3,515.3,296);
...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(300,149,0.56,0.56,0,0,0,0.1,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(132,64.4,336,169.2);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(301,152,0.53,0.53);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(142,58.1,318,187.9);
...
p.nominalBounds = new cjs.Rectangle(25,297,575.9,903.1);
...
p.nominalBounds = new cjs.Rectangle(173,338,524,861.8);
...
p.nominalBounds = new cjs.Rectangle(0,-6.6,258.9,45.6);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(130,62,340,173);
	...
	this.text_1.cache(140,56,322,192);
