...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/BlueGradientImage.png?1481834432314", id:"BlueGradientImage"},
		{src:"images/img_athlete1.png?1481834432314", id:"img_athlete1"},
		{src:"images/img_athlete2.png?1481834432314", id:"img_athlete2"},
		{src:"images/img_facilities.png?1481834432314", id:"img_facilities"}
	]
};
...
(lib.textheadline2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(159,148.9,0.44,0.44,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(27,104,264,89.9);
...
(lib.textheadline1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(161,150.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(29,116.7,264,68.3);
...
p.nominalBounds = new cjs.Rectangle(2,5,202.3,270.4);
...
p.nominalBounds = new cjs.Rectangle(19,286,301,587.4);
...
p.nominalBounds = new cjs.Rectangle(44,300,390.6,773.2);
...
p.nominalBounds = new cjs.Rectangle(0,-6.6,259.9,45.6);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.text_2.cache(25,102,268,94);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text_2},{t:this.athlete_2}]}).wait(1));

	// text: headline 1
	this.text_1 = new lib.textheadline1();
	this.text_1.parent = this;
	this.text_1.cache(27,115,268,72);
