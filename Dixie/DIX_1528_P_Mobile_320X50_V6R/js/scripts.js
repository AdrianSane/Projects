(function() {
    ...
    // initialize some settings
      ...
      mainTl
          ...
          .set(familyFrame, {scale:7, left:-584, top:50}) // scale family frame
    ...
    function main(){
        ...
        mainTl
          ...
          .to(familyBigFrame, 2, {scaleX:.9, scaleY:.9, x:-99, y:-24, ease: Sine.easeOut, transformOrigin:"50% 50%"}, "-=2") // hide outer family image
          ...
          .to(plate, 1, {opacity:1, rotation:0, y:-35, x:50, ease: Sine.easeIn}, "-=1") // reveal plate
