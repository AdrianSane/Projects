(function() {
    ...
    // initialize some settings
      ...
      mainTl
          ...
          .set(familyFrame, {scale:7, left:-584, top:53}) // scale family frame
          ...
          .set(familyBigFrame, {scale:1.1}); // set scale for
    ...
    function main(){
        ...
        mainTl
          // frame 1
          .to(familyContainer, 2, {scale:.15, left:142, right:0, top:-6, bottom: 0, ease: Sine.easeOut}) // scale family container down
          .to(familyBigFrame, 2, {scaleX:1.1, scaleY:1.1, x:-115, y:-11, ease: Sine.easeOut, transformOrigin:"50% 50%", rotationY:.01}, "-=2") // hide outer family image
          //.to(familyBigFrame, .5, {opacity:0}, "-=.5")
          .to(endFrameBG, 2, {scale:1.25, x:0, ease: Sine.easeOut}, "-=2") // reveal endframe bg
          ...
          .to(plate, 1, {opacity:1, rotation:0, y:-55, x:10, ease: Sine.easeIn}, "-=1") // reveal plate
