...
d5banner.main = function() {
    ...
    function bgIn(e) {
        ...
        _tl.set([_mask, outline], {rotation:20, transformOrigin:"top left", x: 1, y: -67});
        ...
        _tl.set(_bg, {rotation:-20, x: 120, y: 17});
        ...
        _tl
            ...
            .from(_mask, 1.6, { clip:"rect(0, 0, 725px, 0)", ease:Power3.easeOut}, "reveal")
