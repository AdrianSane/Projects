...
d5banner.main = function() {
    ...
    function bgIn(e) {
        ...
        _tl.set([_mask, outline], {rotation:20, transformOrigin:"top left", x: 58, y: -253});
        ...
        _tl.set(_bg, {rotation:-20, x: 25, y: 129});
        ...
        _tl
            ...
            .from(_mask, 1.6, { clip:"rect(0, 0, 375px, 0)", ease:Power3.easeOut}, "reveal")
            // tween the gold outline to follow the mask
            .to(outline, 1.6, {width:950, ease:Power3.easeOut,
                onComplete:function(){
