...
d5banner.main = function() {
    ...
    function bgIn(e) {
        ...
        _tl.from(_bg, 1.2, { clip:"rect(0, -480px, 600px, -480px)", ease:Power3.easeInOut});
    ...
    function carIn(e) {
        ...
        var _body = e.body;
        var _tl = new TimelineLite();
        _tl.from(_car, 1, {x:-200, ease:Power3.easeInOut})
    ...
    function carOut(e) {
        ...
        var _body = e.body;
        var _tl = new TimelineLite();
        _tl.to(_car, 1, {x:200, ease:Power3.easeIn})
    ...
    function copyIn(e) {
        ...
        _tl.set(_mask, {rotation:20});
        _tl.set(_copy, {rotation:-20});

        _tl.from(_mask, 1.2, { clip:"rect(0, 0, 600px, 0)", ease:Power3.easeInOut });
    ...
    function copyOut(e) {
        ...
        var _tl = new TimelineLite();
        _tl.to(_mask, 1.2, { clip:"rect(0, 480px, 600px, 480px)", ease:Power3.easeInOut });
    ...
    function enableDisclaimer() {
        ...
        disclaimerBtn.onclick = function showDisclaimer(e) {
          e.preventDefault();
            TweenLite.to(disclaimerPanel, 0.6, {top: 400, parseTransform:true, ease:Power2.easeOut});
            return false;
        }

        closeBtn.onclick = function hideDisclaimer(e) {
          e.preventDefault();
            TweenLite.to(disclaimerPanel, 0.4, {top: 600, parseTransform:true, ease:Power2.easeIn});
            return false;
    ...
    function mainAnimation() {
        ...
        mainTl
            ...
            .add("endFrame", 12)
            .to(hashtagGrey, 0.2, {autoAlpha:0, ease:Power2.easeOut}, "endFrame")
            .from(genone, 0.3, {autoAlpha:0, ease:Power2.easeOut}, "endframe")
            .staggerFromTo(".car-wrapper", 1, {autoAlpha:0, scale:0.8, x:"+=150"}, {autoAlpha: 1, scale:1, x:"0", transformOrigin:"right center", ease:Power3.easeOut}, 0.1, "endframe")
