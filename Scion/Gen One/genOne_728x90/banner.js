...
d5banner.main = function() {
    ...
    function bgIn(e) {
        ...
        _tl.from(_bg, 1.5, { clip:"rect(0, -800px, 240px, -800px)", ease:Power3.easeInOut});
    ...
    function carIn(e) {
        ...
        var _body = e.body;
        var _tl = new TimelineLite();
        _tl.from(_car, 1.5, {x:-800, ease:Power3.easeInOut})
    ...
    function carOut(e) {
        ...
        var _body = e.body;
        var _tl = new TimelineLite();
        _tl.to(_car, 1.5, {x:800, ease:Power3.easeIn})
            .to(_wheels, 1, {rotation:720, ease:Power1.easeIn}, "-=1.2");
    ...
    function copyIn(e) {
        ...
        var _tl = new TimelineLite();
        _tl.set(_mask, {rotation:20, top: -90});
        _tl.set(_copy, {rotation:-20, top: 124});
        _tl.from(_mask, 1.5, { clip:"rect(0, 0, 240px, 0)", ease:Power3.easeInOut });
        return _tl;
    }
    ...
    function copyOut(e) {
        ...
        var _mask = _copy.parentNode;
        var _tl = new TimelineLite();
        _tl.to(_mask, 1.5, { clip:"rect(0, 800px, 240px, 800px)", ease:Power3.easeInOut });
        return _tl;
    }
    ...
    function enableDisclaimer() {
        ...
        closeBtn.onclick = function hideDisclaimer(e) {
          e.preventDefault();
            TweenLite.to(disclaimerPanel, 0.6, {top:90, parseTransform:true, ease:Power3.easeOut});
    ...
    function mainAnimation() {
        ...
        mainTl
            ...
            .staggerFromTo(".car-wrapper", 1, {autoAlpha:0, scale:0.8, x:"+=20"}, {autoAlpha: 1, scale:1, x:"0", transformOrigin:"right center", ease:Power3.easeOut}, 0.1, "endframe")
