...
var card1Start = { x:330, y:-120, z:100, scale:1.05 },
    card1End = { x:10, y:266.5, z:1, rotation:0, rotationY:0, ease:Power4.easeOut},
    card2Start = { x:270, y:-220, z:100, scale:1.02 },
    card2End = { x:34.5,  y:248,  z:5, rotation:0, ease:Power4.easeOut},
    card3Start = {x:400, y:-280, z:100, rotation:-40},
    card3End = { x:84.5, y:235,  z:10, rotationY:0, rotation:0, ease:Power4.easeOut};
...
function dotsAnim() {
    //copy1
        blue.from("#blue", 0.42, {height: "5px", autoAlpha: 0}, 0.0);
        ...
        blue.to("#blue", 0.3, {height: "13px", y: 2});
        blue.to("#blue", 0.2, {height: "19px", y: -1});
        blue.to("#blue", 0.3, {height: "5px", y: 5});

        red.from("#red", 0.42, {height: "5px", autoAlpha: 0}, 0.0);
        ...
        yellow.from("#yellow", 0.42, {height: "5px", autoAlpha: 0}, 0.0);
        ...
        yellow.to("#yellow", 0.2, {height: "23px", y: -2});
        yellow.to("#yellow", 0.3, {height: "11px", y: 3});
        yellow.to("#yellow", 0.3, {height: "5px", y: 5});

        green.from("#green", 0.42, {height: "5px", autoAlpha: 0}, 0.0);
        ...
        green.to("#green", 0.2, {height: "15px", y: 1});
        green.to("#green", 0.3, {height: "7px", y: 5});
        green.to("#green", 0.3, {height: "5px", y: 5});
