...
var card1Start = { x:600, y:-180, z:100, scale:1.05 },
    card1End = { x:431.5, y:38, z:1, rotation:3.5, rotationY:0, ease:Power4.easeOut},
    card2Start = { x:675, y:-220, z:100, scale:1.02 },
    card2End = { x:465,  y:7,  z:5, rotation:-1.505, ease:Power4.easeOut},
    card3Start = {x:580, y:-280, z:100, rotation:-40},
    card3End = { x:505.5, y:-3.5,  z:10, rotationY:0, rotation:3.2, ease:Power4.easeOut};
...
function cardsAnim() {
    ...
    .add([
        ...
        TweenLite.to(card1, 1.2, {scale:1, ease:Power1.easeOut}),
        TweenLite.to(card1, 2, card1End, "-=1.8"),
    ])
    .add([
        TweenLite.from(card1Shadow, 0.8, {autoAlpha:0, ease:Power1.easeIn}),
        TweenLite.from(card1Shadow, 0.7, {scale:0.8, z:-10, transformOrigin:"100% 50%", ease:Power1.easeOut})
        ], "-=1.6");

    var card2Tl = new TimelineLite();
    card2Tl
    .add([
       TweenLite.to(card2, 1.75, {rotation:-13, ease:Power3.easeOut}),
        TweenLite.from(card2, 1.6, {rotationY:60}),
        TweenLite.to(card2, 1.85, card2End, "-=1.5"),
        TweenLite.to(card2, 0.8, {scale:1, ease:Power1.easeOut, delay:0.9})
    ])
    .to(card1Fx, 1.2, {autoAlpha:0.65, ease:Power1.easeOut}, "-=1");
    ...
    .add([
        ...
        TweenLite.to(card2Fx, 1, {autoAlpha:1, ease:Power1.easeOut, delay:0.75})
    ]);
...
function dotsAnim() {
    ...
    //copy1
    blue.from("#blue", 0.42, {height: "4px", autoAlpha: 0}, 0.0);
    ...
    blue.to("#blue", 0.3, {height: "13px", y: 2});
    blue.to("#blue", 0.2, {height: "19px", y: -1});
    blue.to("#blue", 0.3, {height: "4px", y: 5});

    red.from("#red", 0.42, {height: "4px", autoAlpha: 0}, 0.0);
    ...
    yellow.from("#yellow", 0.42, {height: "4px", autoAlpha: 0}, 0.0);
    yellow.to("#yellow", 0.2, {height: "21px", y: -1}, 0.3);
    ...
    yellow.to("#yellow", 0.2, {height: "21px", y: -2});
    ...
    yellow.to("#yellow", 0.2, {height: "21px", y: -2});
    yellow.to("#yellow", 0.3, {height: "11px", y: 3});
    yellow.to("#yellow", 0.3, {height: "4px", y: 5});

    green.from("#green", 0.42, {height: "4px", autoAlpha: 0}, 0.0);
    ...
    green.to("#green", 0.2, {height: "15px", y: 1});
    green.to("#green", 0.3, {height: "7px", y: 5});
    green.to("#green", 0.3, {height: "4px", y: 5});
