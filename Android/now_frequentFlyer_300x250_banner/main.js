...
var card1Start = { x:330, y:-90, z:100, scale:1.05 },
    card1End = { x:51, y:163, z:1, rotation:0, rotationY:0, ease:Power4.easeOut},
    card2Start = { x:370, y:-120, z:100, scale:1.02 },
    card2End = { x:90,  y:125,  z:5, rotation:10.60, ease:Power4.easeOut},
    card3Start = {x:400, y:-280, z:100, rotation:-40},
    card3End = { x:146, y:112,  z:10,  rotation:10.12, ease:Power4.easeOut};
...
function cardsAnim() {
    ...
    .to(card1Fx, 1.2, {autoAlpha:0.65, ease:Power1.easeOut}, "-=1.3");
    ...
    .add([
        ...
        TweenLite.to(card2Fx, 1, {autoAlpha:1, ease:Power1.easeOut, delay:0.5})
    ]);
