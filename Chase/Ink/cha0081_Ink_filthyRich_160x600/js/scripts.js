(function() {
    ...
    function main() {
        ...
        mainTl
            .set(chase_logo, {x: 14, y: HEIGHT})
            // add a start label
            .add("start", 0.5)
            .set(banner, {autoAlpha: 1})
            // show the card
            .fromTo(card, 0.75, {x:10, y:600, force3D: true, rotateZ:0.001},{y: 413, ease:Power3.easeOut}, "start+=0.2")
            // show the bottom white footer area
            .fromTo(bottom_white, 0.5, {y: HEIGHT}, {y: 477, transformOrigin:"bottom", ease:Power3.easeOut}, "start+=0.2")
            // show the logo
            .to(chase_logo, 0.4, {y:530, autoAlpha: 1, ease:Power3.easeOut}, "start+=0.4")
            ...
            // scale the card down
            .to(card, 0.8, {y:361, ease:Power3.easeOut}, "frame2+=0.2")
            .to(bottom_white, 0.4, {y: 425, ease: Power3.easeOut}, "frame2+=0.2")

            .to(text_2, 0.8, {autoAlpha:1}, "frame2+=0.6")
            .to(text_2, 0.4, {y: "+=10", ease:Power3.easeOut}, "frame2+=0.6")

            .to(cta, 0.4, {autoAlpha:1}, "frame2+=.4")
            .from(cta, 0.4, {y: "+=30", ease: Back.easeOut}, "frame2+=.4")
