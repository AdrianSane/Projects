(function() {
    ...
    function main() {
        ...
        mainTl
            .set(chase_logo, {x: 74, y: 226})
            // add a start label
            .add("start", 0.5)
            .set(banner, {autoAlpha: 1})
            // show the card
            .fromTo(card, 0.75, {x:48, y:300, force3D: true, rotateZ:0.001},{y: 82, ease:Power3.easeOut}, "start+=0.2")
            ...
            // scale the card down
            .to(card, 0.8, {scale:0.42, x:134, y:150, ease:Power3.easeOut}, "frame2+=0.2")
            ...
            // scale card
            .to(card, 0.4, {scale:0.87, x:51, y:86, ease:Power3.easeOut}, "endframe+1")
