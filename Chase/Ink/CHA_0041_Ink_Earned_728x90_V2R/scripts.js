(function() {
    ...
    mainTl.set(bottom_white, {x:448});
    mainTl.set(banner, {autoAlpha:1});
    mainTl.set(card, {x: 379, y: 3, force3D:true, rotateZ:0.001});
    mainTl.set(chase_logo, {x: 570, y: 21});
    ...
    function main() {
        ...
        mainTl
            ...
            // scale logo down
            .to(chase_logo, 0.4, {scale: 0.75, y:5, ease:Power1.easeOut}, "endframe+=1.3")
