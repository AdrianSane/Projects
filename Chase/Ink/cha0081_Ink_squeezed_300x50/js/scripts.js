(function() {
    ...
    function main() {
        ...
        mainTl
            ...
            // show the card
            .fromTo(card, 0.75, {x:300, y: 4, force3D: true, rotateZ:0.001},{x: 120, ease:Power3.easeOut}, "start+=0.2")
            // show the bottom white footer area
            .fromTo(bottom_white, 0.65, {x: 300}, {x: 168, ease:Power3.easeOut}, "start+=0.2")
            // show the logo
            .to(chase_logo, 0.4, {x:197, autoAlpha: 1, ease:Power3.easeOut}, "start+=0.4")
            ...
            // move the card left
            .to(card, 0.8, { x:132, ease:Power3.easeOut}, "frame2+=0.2")
