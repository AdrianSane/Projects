(function() {
    ...
    mainTl.set(bottom_white, {y: 386});
    mainTl.set(banner, {autoAlpha:1});
    mainTl.set(card, {x: 15, y: 310, force3D:true, rotateZ:0.001});
    mainTl.set(chase_logo, {x: 45, y: 500});
    ...
    function main() {
        ...
        mainTl
            ...
            .add("start", 0.5)
            // show the card
            .from(card, 0.75, {y: 602, ease:Power3.easeOut}, "start+=0.2")
            ...
            // scale logo down
            .to(chase_logo, 0.4, {scale:0.75, y: 475, ease:Power1.easeOut}, "endframe+=1.3")
