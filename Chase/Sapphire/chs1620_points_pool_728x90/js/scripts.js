...
(function() {
    ...
    mainTl
        ...
        // show footer
        .from(footer, 0.4, {x:"+=160", ease:Sine.easeOut}, "start")
        .from(card_footer, 0.4, {x:"+=160", autoAlpha:0, ease:Sine.easeOut}, "start+=0.1")// plus logo

        .add("headline1", "+=0.5")
        .staggerFrom(headline1a, 0.8, {autoAlpha:0}, 0.05, "headline1")
        ...
        // next headline
        .add("wipe", "+=1.2")
        .staggerTo(card_footer, 1.1, {x:WIDTH , ease:Power3.easeInOut}, 0.1, "wipe")

        // wipe footer up
        .to(footer, 0.4, {width:WIDTH, left:0, ease:Power3.easeIn}, "wipe+=0.8")
        .from(headline1b, 1, {autoAlpha:0, y:"+=10", ease:Circ.easeOut}, "wipe+=1.2")
        .from(card_main, 0.75, {x:"-=100", ease:Circ.easeOut}, "wipe+=1.3")
        .from(card_main, 0.4, {autoAlpha:0}, "wipe+=1.4")

        // show cta and logo
        .to(logo_sapphire, 0.4, {autoAlpha:1}, "wipe+=1.3")
        .from(cta, 0.6, {autoAlpha:0, y:"+=60", ease:Circ.easeOut}, "wipe+=1.75");
