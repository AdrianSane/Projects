...
(function() {
    ...
    mainTl.set(logo, {x:46, y:516});
    mainTl.set(silverware, {y:-191});
    mainTl.set(plate, {x:0, y:179, rotationZ: 15});
    ...
    mainTl
        ...
        // show footer
        .from(footer, 0.4, {y:HEIGHT, ease:Sine.easeOut}, "start")
        ...
        .from(silverware, 1, {x:"-=100"}, "elements-=0.5")
        ...
        // next headline
        .add("wipe", "+=1.2")
        .staggerTo(card_footer, 0.8, {x:WIDTH , ease:Power3.easeIn}, 0.1, "wipe")
