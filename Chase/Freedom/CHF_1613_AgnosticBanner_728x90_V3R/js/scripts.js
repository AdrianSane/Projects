...
(function() {
    ...
    var banner = document.getElementById('banner'),
        ...
        logo_endframe = document.getElementById('logo_endframe'),
    ...
    mainTl
        ...
        .add("endFrame", "+=2.4")
        // ellie out!
        .staggerTo([ellie2, copy4], 0.75, {y:HEIGHT + 10, ease:Power1.easeInOut}, 0.1, "endFrame")
        .staggerFrom([card2, headline], 0.75, {y: copyStart, ease:Power1.easeInOut}, 0.2, "endFrame+=0.1")
        .to(footer, 0.25, {width: 268, ease:Power2.easeOut, x:-155}, 'endFrame+=0.1')
        .to(logo, 0.25, {autoAlpha:0, y: 20}, "-=.2")
        .fromTo([cta, logo_endframe], 0.5, {y:"+=20", autoAlpha:0}, {y:"0", autoAlpha:1, ease:Back.easeInOut});
